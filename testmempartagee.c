...
#define TAILLE_SHM 10000000/* la fonction principale prend des arguments : argccontient le nombre d'arguments, et argvest un pointeur vers les arguments */
int main(int argc, char *argv[]){
key_t key;
int shmid;
char *data;
key = ftok("shmdemo.c", 'R');/* allocation du segment de mémoire partagée */
